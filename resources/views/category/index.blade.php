                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#deleteConfirm{{ $item->category_id }}"
                                    ...
                                    <div class="modal fade" id="deleteConfirm{{ $item->category_id }}" data-bs-backdrop="static"
