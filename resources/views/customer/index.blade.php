                                                    ...
                                                    App\Helpers\PermissionHelper::hasPermission('read')
                                                                                            ...
                                                                                            @if (App\Helpers\PermissionHelper::hasPermission('read'))
                                                                                                <a href="{{ route('customer.show', $item->customer_id) }}"
                                                                                                    class="btn btn-info btn-sm"> <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                                                            ...
                                                                                            <button type="button" data-bs-toggle="modal"
                                                                                                data-bs-target="#deleteConfirm{{ $item->customer_id }}"
