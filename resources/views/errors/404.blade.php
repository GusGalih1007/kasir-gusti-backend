      ...
      <div class="offcanvas-body data-scrollbar">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="d-grid gap-3 grid-cols-2 mb-4">
              <div class="text-center">
                <img src="{{ asset('hope-ui/html/assets/images/settings/dark/06.pn')}}g" alt="rounded-one-side"
                  class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
...
<div class="gradient">
    <div class="container">
        <img src="{{ asset('hope-ui/html/assets/images/error/404.png')}}" class="img-fluid mb-4 w-50" alt=""> 
