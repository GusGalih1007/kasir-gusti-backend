...
<head>
    ...
    <titl assete>Hope UI | Responsive Bootstrap 5 Admin Dashboard Template</titl>
    ...
    <!-- asset Hope Ui Design System Css -->
    <link rel="stylesheet" href="{{ asset('hope-ui/html/assets/cs assets/hope-ui.min.css?v=5.0.0') }}">
...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('hope-ui/html/assets/images/settings/dark/07.png') }}"
                                alt="rounded-all"
                                class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <img src="{{ asset('hope-ui/html/assets/images/settings/light/07.png') }}"
                                alt="rounded-all"
                                class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('hope-ui/html/assets/images/settings/dark/08.png') }}"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('hope-ui/html/assets/images/settings/dark/13.png') }}"
                            ...
                            <img src="{{ asset('hope-ui/html/assets/images/settings/light/13.png') }}"
    ...
    <div class="wrapper">
        <div class="container-fluid p-0">
            <div class="iq-maintenance text-center">
                <img src="{{ asset('hope-ui/html/assets/images/error/01.png') }}" class="img-fluid mb-4"
                    alt="">
    ...
    <!-- App Script -->
    <script src="{{ asset('hope-ui/html/assets/j assets/hope-ui.js') }}" defer></script>


    <script src="{{ asset('hope-ui/html/assets/js/plugins/countdown.js') }}"></script>
</body>
