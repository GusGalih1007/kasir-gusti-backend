            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                {{-- <li class="nav-item dropdown">
                    <a href="#" class="search-toggle nav-link" id="dropdownMenuButton2"
                        ...
                        <img src="{{ asset('hope-ui/html/assets/images/Flag/flag001.png')}}" class="img-fluid rounded-circle" alt="user"
                            style="
                                                height: 30px;
                                                min-width: 30px;
                                                width: 30px;
                            ...
                            <div class="p-0">
                                <ul class="p-0 list-group list-group-flush">
                                    <li class="iq-sub-card list-group-item">
                                        <a class="p-0 d-flex justify-content-start d-flex align-items-center"
                                            href="#"><img src="{{ asset('hope-ui/html/assets/images/Flag/flag-03.png')}}"
                                    ...
                                    <li class="iq-sub-card list-group-item">
                                        <a class="p-0 d-flex justify-content-start d-flex align-items-center"
                                            href="#"><img src="{{ asset('hope-ui/html/assets/images/Flag/flag-04.png')}}"
                                                alt="img-flaf" class="img-fluid me-2"
                                                style="
                                                                    width: 15px;
                                                                    height: 15px;
                                    ...
                                    <li class="iq-sub-card list-group-item">
                                        <a class="p-0 d-flex justify-content-start d-flex align-items-center"
                                            href="#"><img src="{{ asset('hope-ui/html/assets/images/Flag/flag-02.png')}}"
                                                alt="img-flaf" class="img-fluid me-2"
                                                style="
                                                                    width: 15px;
                                                                    height: 15px;
                                    ...
                                    <li class="iq-sub-card list-group-item">
                                        <a class="p-0 d-flex justify-content-start d-flex align-items-center"
                                            href="#"><img src="{{ asset('hope-ui/html/assets/images/Flag/flag-05.png')}}"
                                                alt="img-flaf" class="img-fluid me-2"
                                                style="
                                                                    width: 15px;
                                                                    height: 15px;
                                    ...
                                    <li class="iq-sub-card list-group-item">
                                        <a class="p-0 d-flex justify-content-start d-flex align-items-center"
                                            href="#"><img src="{{ asset('hope-ui/html/assets/images/Flag/flag-06.png')}}"
                                                alt="img-flaf" class="img-fluid me-2"
                                                style="
                                                                    width: 15px;
                                                                    height: 15px;
                            ...
                            <div class="p-0 card-body">
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                            src="{{ asset('hope-ui/html/assets/images/shapes/01.png')}}" alt="" />
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                                src="{{ asset('hope-ui/html/assets/images/shapes/02.png')}}" alt="" />
                                        </div>
                                        <div class="ms-3 w-100">
                                            <h6 class="mb-0 text-start iq-text">
                                                New customer is
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                            src="{{ asset('hope-ui/html/assets/images/shapes/03.png')}}" alt="" />
                                        <div class="ms-3 w-100">
                                            <h6 class="mb-0 text-start iq-text">
                                                Two customer is
                                                left
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                            src="{{ asset('hope-ui/html/assets/images/shapes/04.png')}}" alt="" />
