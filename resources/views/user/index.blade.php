                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if (
                                                    App\Helpers\PermissionHelper::hasPermission('update') ||
                                                    App\Helpers\PermissionHelper::hasPermission('delete') ||
                                                    App\Helpers\PermissionHelper::hasPermission('read')
                                                )
                                                @if (App\Helpers\PermissionHelper::hasPermission('update'))
                                                    <a href="{{ route('user.edit', $item->user_id) }}" class="btn btn-warning btn-sm">
                                                ...
                                                @endif
                                                @if (App\Helpers\PermissionHelper::hasPermission('read'))
                                                    <a href="{{ route('user.show', $item->user_id) }}" class="btn btn-info btn-sm"> <svg
                                                            class="icon-16" width="16" viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                @if (App\Helpers\PermissionHelper::hasPermission('delete'))
                                                    <button type="button" data-bs-toggle="modal"
                                                        data-bs-target="#deleteConfirm{{ $item->user_id }}"
