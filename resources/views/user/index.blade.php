                        ...
                        <table id="datatable" data-toggle="data-table" class="table table-hover table-bordered">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                                    ...
                                                    <a href="{{ route('user.show', $item->user_id) }}"
                                                        class="btn btn-info btn-sm"> <svg class="icon-16" width="16"
                                                            ...
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                ...
                                                                stroke="currentColor" stroke-width="1.5"
                                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                                            <path d="M11.9946 16V12" stroke="currentColor"
                                                                stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round">
                                                            </path>
                                    ...
                                    <div class="modal fade" id="deleteConfirm{{ $item->user_id }}"
